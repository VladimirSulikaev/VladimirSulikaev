...
| ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------- |
| [Пайплайн обработки данных на Spark, Airflow и Greenplum](https://github.com/VladimirSulikaev/spark-airflow-greenplum-pipeline)          | Разработал пайплайн, который обрабатывает данные из S3 с помощью Spark в Kubernetes, формирует пять отчётных витрин в Parquet и предоставляет к ним SQL-доступ через Greenplum PXF. Запуск и контроль параллельных задач организованы в Airflow.       | Python, PySpark, Apache Airflow, Kubernetes, S3, Greenplum, PXF            |
| [Автоматическая обработка офферов из Slack через n8n и OpenAI](https://github.com/VladimirSulikaev/slack-openai-offers-etl)          | Создал автоматизированный процесс, который собирает офферы из внутреннего канала, парсит их через OpenAI, нормализует данные и сохраняет в Google Sheets для удобного анализа.       | n8n, Slack API, OpenAI API, Google Sheets API            |
